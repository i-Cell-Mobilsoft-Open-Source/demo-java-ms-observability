...
import hu.icellmobilsoft.sampler.sample.restservice.demo.action.DemoMetricAction;
import hu.icellmobilsoft.sampler.sample.restservice.demo.action.RestSlowDemoAction;
 ...
 */
@Model
public class RestSlowDemoRest extends BaseRestService implements ISampleRestRegisteredClient {

	@Inject
	private RestSampleGetAction restSampleAction;

	@Inject
	private RestSlowDemoAction restSlowDemoAction;

	@Inject
	private DemoMetricAction demoMetricAction;
	...
	public SampleResponse getSlowDemo() throws BaseException {
		return restSlowDemoAction.slowDemo();
	}

	@Override
	public SampleResponse getDemoMetrics() throws BaseException {
		return demoMetricAction.demo();
	}
